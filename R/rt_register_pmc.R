...
#'
#' @return Index of element with phrase of interest
get_reg_title_2 <- function(article, synonyms) {
...
#' @return Index of element with phrase of interest
get_reg_title_pmc <- function(article) {
...
get_reg_title_fun <- function(article_xml) {
...
#' @export
rt_register_pmc <- function(filename) {
  ...
  # Go through titles
  title_txt <- get_reg_title_fun(article_xml)
